...
import com.witness.customdialog.view.CircleProgressBar;
import com.witness.customdialog.view.ProgressDefaultView;

import java.lang.ref.WeakReference;

public class CustomDialog {
    private WeakReference<Context> contextWeak;
    private static final long DISMISSDELAYED = 2500;
    ...
    public Animation getInAnimation() {
        ...
        int res = CustomDialogAnimateUtil.getAnimationResource(this.gravity, true);
    ...
    public Animation getOutAnimation() {
        ...
        int res = CustomDialogAnimateUtil.getAnimationResource(this.gravity, false);
        return AnimationUtils.loadAnimation(context, res);
    }
